...
export function Navbar() {
  ...
  return(
    <div className="flex justify-between md:justify-around gap-5 border-gray-300 dark:border-gray-700 p-2
            md:px-3 z-20 border-b-2 ">
      {
        navdata.map((data, index) => (
          <div className={`${data.link == pathname ? 'bg-blue-400' : ''} rounded-md flex items-center gap-3 cursor-pointer p-2`} key={index}>
